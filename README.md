...
```
bash <(curl -fsSL https://raw.githubusercontent.com/Badutpsr/zivpn/main/menuzivpn)
```
#### ZIVPN v1

```
bash <(curl -fsSL https://raw.githubusercontent.com/Badutpsr/zivpn/main/ziv1.sh)
```
#### ZIVPN v2 AMD

```
bash <(curl -fsSL https://raw.githubusercontent.com/Badutpsr/zivpn/main/ziv2.sh)
```
#### ZIVPN v2 ARM

```
bash <(curl -fsSL https://raw.githubusercontent.com/Badutpsr/zivpn/main/ziv3.sh)
```
